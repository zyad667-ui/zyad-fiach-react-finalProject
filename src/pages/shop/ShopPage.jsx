...
function FilterSidebar({ selectedType, setSelectedType, selectedFilters, setSelectedFilters }) {
    ...
    return (
        <aside className="w-full max-w-xs border-r border-gray-200 px-4 py-6 bg-white">
            {/* Product Types */}
            <ul className="mb-6">
